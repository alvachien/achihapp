...
import { ControlCenter, SettlementRule, ModelUtility, ConsoleLogTypeEnum, getUIModeString, Order } from '../../../../model';
    ...
    this.detailFormGroup = new UntypedFormGroup(
      {
        ...
        endDateControl: new UntypedFormControl(new Date(), [Validators.required]),
