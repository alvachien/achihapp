...
export class AccountExtraAdvancePayment extends AccountExtra {
  ...
  constructor() {
    ...
    this._endDate = addYears(this._startDate, 1);
  }
  ...
  get isAccountValid(): boolean {
    ...
    if (isEqual(this.StartDate, this.EndDate) || isAfter(this.StartDate, this.EndDate)) {
      return false;
    }
  ...
  public clone(): AccountExtraAdvancePayment {
    ...
    aobj.StartDate = new Date(this.StartDate);
    aobj.EndDate = new Date(this.EndDate);
  ...
  public override writeJSONObject(): any {
    ...
    rstobj.StartDate = format(this._startDate, hih.DateDisplayFormat);
    rstobj.EndDate = format(this._endDate, hih.DateDisplayFormat);
...
export class AccountExtraAsset extends AccountExtra {
  ...
  public override writeJSONObject(): AccountExtraAssetJson {
    ...
    rstobj.Comment = this.Comment;
    if (this.BoughtDate) {
      rstobj.BoughtDate = format(this.BoughtDate, hih.DateDisplayFormat);
    }
    if (this.ExpiredDate) {
      rstobj.ExpiredDate = format(this.ExpiredDate, hih.DateDisplayFormat);
    }
...
export class AccountExtraLoan extends AccountExtra {
  ...
  get StartDateFormatString(): string | null {
    if (this._startDate !== null) {
      return format(this._startDate, hih.DateDisplayFormat);
    }
    return null;
  }
  ...
  get EndDateFormatString(): string | null {
    if (this._endDate !== null) {
      return format(this._endDate, hih.DateDisplayFormat);
    }
    return null;
  }
  ...
  get isAccountValid(): boolean {
    ...
    if(isEqual(this.endDate!, this.startDate!) || isBefore(this.endDate!, this.startDate!)) {
      return false;
    }
    ...
    if (this.FirstRepayDate && this.RepayDayInMonth) {
      if (this.FirstRepayDate.getDay() !== this.RepayDayInMonth) {
        return false;
      }
    }
  ...
  public override writeJSONObject(): AccountExtraLoanJson {
    ...
    rstobj.StartDate = this._startDate ? format(this._startDate, hih.DateDisplayFormat) : '';
    if (this._endDate) {
      rstobj.EndDate = this._endDate ? format(this._endDate, hih.DateDisplayFormat) : '';
    }
    if (this.annualRate) {
...
export class AccountReconcileExpect {
  ...
  get currentMonthStr(): string {
    return format(this.currentMonth, hih.DateDisplayFormat);
  }
...
export class Order extends hih.BaseModel {
  ...
  get ValidFromFormatString(): string {
    return this._validFrom ? format(this._validFrom, hih.DateDisplayFormat) : '';
  }
  get ValidToFormatString(): string {
    return this._validTo ? format(this._validTo, hih.DateDisplayFormat) : '';
  }
  ...
  public override onInit(): void {
    ...
    this._validTo = addMonths(new Date(this._validFrom), 1);
    this.SRules = [];
  }
  ...
  public override writeJSONObject(): OrderJson {
    ...
    rstObj.HomeID = this.HID;
    rstObj.Name = this.Name;
    rstObj.ValidFrom = this._validFrom ? format(this._validFrom, hih.DateDisplayFormat) : '';
    rstObj.ValidTo = this._validTo ? format(this._validTo, hih.DateDisplayFormat) : '';
    rstObj.Comment = this.Comment;
    rstObj.SRule = [];
...
export class Document extends hih.BaseModel {
  ...
  public override writeJSONObject(): DocumentJson {
    ...
    rstObj.TranDate = format(this._tranDate, hih.DateDisplayFormat);
...
export abstract class TemplateDocBase extends hih.BaseModel {
  ...
  public override writeJSONObject(): any {
    ...
    rstObj.ReferenceDocumentID = this.RefDocId;
    rstObj.AccountID = this.AccountId;
    rstObj.TransactionDate = this._tranDate ? format(this._tranDate, hih.DateDisplayFormat) : '';
...
export class Plan extends hih.BaseModel {
  ...
  get StartDateString(): string {
    return this._startDate ? format(this._startDate, hih.DateDisplayFormat) : '';
  }
  ...
  get TargetDateString(): string {
    return this._targetDate ? format(this._targetDate, hih.DateDisplayFormat) : '';
  }
  ...
  public override onInit(): void {
    ...
    this._startDate = new Date();
    this._targetDate = startOfDay(addDays(this._startDate, 1));;
  }
  public override onVerify(context?: any): boolean {
    ...
    if (bsuccess) {
      ...
      if (isAfter(today, this.TargetDate!)) {
        this._addMessage(hih.MessageType.Error, 'Common.InvalidDate', 'Common.InvalidDate');
        bsuccess = false;
      }
      if (this.StartDate && (isEqual(this.StartDate, this.TargetDate!) || isAfter(this.StartDate, this.TargetDate!))) {
        this._addMessage(hih.MessageType.Error, 'Common.InvalidDate', 'Common.InvalidDate');
        bsuccess = false;
      }
      // Check account! - TBD
  ...
  public override writeJSONObject(): any {
    ...
    rstObj.StartDate = this.StartDate ?? format(this.StartDate!, hih.DateDisplayFormat);
    rstObj.TargetDate = this.TargetDate ?? format(this.TargetDate!, hih.DateDisplayFormat);
...
export class DocumentWithPlanExgRate {
  ...
  get TranDateDisplayString(): string {
    return format(this.TranDate, hih.DateDisplayFormat);
  }
  public Desp = '';
  public TranCurr = '';
  public ExgRate = 0;
